    ...
    <div className="bg-[#F5F5F0] min-h-screen">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-red-50 to-orange-50 rounded-xl p-8 mb-12 border-l-4 border-red-600 hover:shadow-xl transition-all duration-500">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {timelineCards.map((card, index) => (
              <div
                key={index}
                className="relative bg-white rounded-xl shadow-lg p-8 border-t-4 border-red-600 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group"
              >
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* Text bên trái */}
            <div>
              <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition-shadow duration-500">
                ...
                <ul className="space-y-4">
                  {unityAspects.map((aspect, index) => (
                    <li
                      key={index}
                      className="flex items-center text-lg text-gray-700 hover:text-red-600 hover:translate-x-2 transition-all duration-300"
                    >
                      <span className="text-3xl mr-4">{aspect.icon}</span>
            ...
            {/* Hình bên phải - placeholder */}
            <div className="bg-gradient-to-br from-red-100 to-orange-100 rounded-xl shadow-lg p-8 flex items-center justify-center min-h-[400px] hover:shadow-2xl transition-all duration-500">
              <div className="text-center">
                <img src={Tanglop} alt="TangLop"/>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Sơ đồ khối */}
          <div className="mb-12">
            <div className="bg-gradient-to-r from-red-600 to-orange-500 rounded-xl p-8 text-center shadow-xl hover:shadow-2xl transition-shadow duration-500">
          ...
          <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500">
